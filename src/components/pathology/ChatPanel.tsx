...
const ChatPanel: React.FC = () => {
  ...
  const { currentCase, isAnalyzing } = useCaseStore();
  ...
  return (
    <aside className="w-full h-full bg-white border-r border-gray-200 flex flex-col z-20 flex-shrink-0 shadow-[4px_0_20px_rgba(0,0,0,0.02)]">
      ...
      <div className="p-3 border-b border-gray-100 bg-slate-50/50 flex items-center justify-between">
        ...
        <span className="text-[9px] bg-white border border-gray-200 px-1.5 py-0.5 rounded text-gray-400">1.2 GB</span>
      </div>
        ...
        <div className="flex gap-3">
          ...
          <div className="flex-1 space-y-3 min-w-0">
            ...
            <div 
              ...
              className="text-xs text-gray-400 flex items-center gap-2 mb-1 cursor-pointer hover:text-gray-600 transition-colors"
            >
            ...
            <div className="bg-white border border-he-100 rounded-xl overflow-hidden shadow-sm">
              <div className="bg-he-50 px-4 py-3 border-b border-he-100 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-he-500 font-mono">Confidence Score: {currentCase.confidenceScore}</p>
                </div>
              </div>
      ...
      <div className="p-4 border-t border-gray-200 bg-white z-10">
        <div className="relative group">
          ...
          <div className="relative bg-white border border-gray-200 rounded-xl flex items-center p-1.5 shadow-sm">
            <button className="p-2 text-gray-400 hover:text-iris-600 transition-colors"><Paperclip className="w-4 h-4" /></button>
            <input 
              type="text" 
            ...
            />
            <button className="p-1.5 bg-slate-900 text-white rounded-lg hover:bg-iris-600 transition-colors shadow-sm"><ArrowUp className="w-4 h-4" /></button>
          </div>
        </div>
      </div>
    </aside>
